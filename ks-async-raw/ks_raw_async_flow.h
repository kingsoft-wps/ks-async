...
struct ks_raw_async_flow_ptr : std::shared_ptr<ks_raw_async_flow> {
	...
	_NO_INLINE ks_raw_async_flow_ptr& operator=(const ks_raw_async_flow_ptr&) noexcept = default;
	_NO_INLINE ks_raw_async_flow_ptr& operator=(ks_raw_async_flow_ptr&&) noexcept = default;
	_NO_INLINE ~ks_raw_async_flow_ptr() noexcept = default;
