...
struct ks_raw_future_ptr : std::shared_ptr<ks_raw_future> {
	...
	_NO_INLINE ks_raw_future_ptr& operator=(const ks_raw_future_ptr&) noexcept = default;
	_NO_INLINE ks_raw_future_ptr& operator=(ks_raw_future_ptr&&) noexcept = default;
	_NO_INLINE ~ks_raw_future_ptr() noexcept = default;
