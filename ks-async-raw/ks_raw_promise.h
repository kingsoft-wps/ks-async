...
struct ks_raw_promise_ptr : std::shared_ptr<ks_raw_promise> {
	...
	_NO_INLINE ks_raw_promise_ptr& operator=(const ks_raw_promise_ptr&) noexcept = default;
	_NO_INLINE ks_raw_promise_ptr& operator=(ks_raw_promise_ptr&&) noexcept = default;
	_NO_INLINE ~ks_raw_promise_ptr() noexcept = default;
