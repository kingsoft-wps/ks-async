...
public:
	_NO_INLINE uint64_t add_flow_running_observer(
	...
	_NO_INLINE uint64_t add_flow_completed_observer(
	...
	_NO_INLINE uint64_t add_task_running_observer(
	...
	_NO_INLINE uint64_t add_task_completed_observer(
		const char* task_name_pattern, 
...
private:
	...
	template <class T>
	_NO_INLINE bool __choose_add_task_by_ret(
