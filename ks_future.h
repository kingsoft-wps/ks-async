...
public: //map, map_value, cast
	template <class R>
	_NO_INLINE ks_future<R> map(std::function<R(const T&)> fn) const {
		ASSERT(!this->is_null());
	...
	_NO_INLINE ks_future<R> map_value(X&& other_value) const {
		ASSERT(!this->is_null());
		ks_raw_future_ptr raw_future2 = m_raw_future->then(
...
private: //__post
	_NO_INLINE static ks_future<T> __post_of_arglist_1_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<T()> task_fn) {
	...
	_NO_INLINE static ks_future<T> __post_of_arglist_1_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<T>()> task_fn) {
		auto raw_task_fn = [task_fn = std::move(task_fn)]()->ks_raw_result {
	...
	_NO_INLINE static ks_future<T> __post_of_arglist_1_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<T>()> task_fn) {
	...
	_NO_INLINE static ks_future<T> __post_of_arglist_2_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<T(ks_cancel_inspector*)> task_fn) {
		auto raw_task_fn = [task_fn = std::move(task_fn)]()->ks_raw_result {
	...
	_NO_INLINE static ks_future<T> __post_of_arglist_2_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<T>(ks_cancel_inspector*)> task_fn) {
		auto raw_task_fn = [task_fn = std::move(task_fn)]()->ks_raw_result {
	...
	_NO_INLINE static ks_future<T> __post_of_arglist_2_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<T>(ks_cancel_inspector*)> task_fn) {
		return ks_future<ks_future<T>>::post(apartment, context, std::move(task_fn))
			.template flat_then<T>(apartment, context, [](const ks_future<T>& value_future) ->ks_future<T> { return value_future; });
	}

private: //__post_delayed
	_NO_INLINE static ks_future<T> __post_delayed_of_arglist_1_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<T()> task_fn, int64_t delay) {
		auto raw_task_fn = [task_fn = std::move(task_fn)]()->ks_raw_result {
			T typed_value = task_fn();
			return ks_raw_value::of<T>(std::move(typed_value));
		};
	...
	_NO_INLINE static ks_future<T> __post_delayed_of_arglist_1_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<T>()> task_fn, int64_t delay) {
		auto raw_task_fn = [task_fn = std::move(task_fn)]()->ks_raw_result {
			ks_result<T> result = task_fn();
			return result.__get_raw();
		};
	...
	_NO_INLINE static ks_future<T> __post_delayed_of_arglist_1_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<T>()> task_fn, int64_t delay) {
		return ks_future<ks_future<T>>::post_delayed(apartment, context, std::move(task_fn), delay)
			.template flat_then<T>(apartment, context, [](const ks_future<T>& value_future) -> ks_future<T> { return value_future; });
	}
	_NO_INLINE static ks_future<T> __post_delayed_of_arglist_2_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<T(ks_cancel_inspector*)> task_fn, int64_t delay) {
		auto raw_task_fn = [task_fn = std::move(task_fn)]()->ks_raw_result {
			T typed_value = task_fn(ks_cancel_inspector::__for_future());
			return ks_raw_value::of<T>(std::move(typed_value));
		};
	...
	_NO_INLINE static ks_future<T> __post_delayed_of_arglist_2_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<T>(ks_cancel_inspector*)> task_fn, int64_t delay) {
		auto raw_task_fn = [task_fn = std::move(task_fn)]()->ks_raw_result {
			ks_result<T> result = task_fn(ks_cancel_inspector::__for_future());
			return result.__get_raw();
		};
	...
	_NO_INLINE static ks_future<T> __post_delayed_of_arglist_2_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<T>(ks_cancel_inspector*)> task_fn, int64_t delay) {
		return ks_future<ks_future<T>>::post_delayed(apartment, context, std::move(task_fn), delay)
			.template flat_then<T>(apartment, context, [](const ks_future<T>& value_future) -> ks_future<T> { return value_future; });
	}

private: //__post_pending
	_NO_INLINE static ks_future<T> __post_pending_of_arglist_1_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<T()> task_fn, ks_pending_trigger* trigger) {
	...
	_NO_INLINE static ks_future<T> __post_pending_of_arglist_1_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<T>()> task_fn, ks_pending_trigger* trigger) {
		auto raw_task_fn = [task_fn = std::move(task_fn)](const ks_raw_result&)->ks_raw_result {
			ks_result<T> result = task_fn();
			return result.__get_raw();
		};
	...
	_NO_INLINE static ks_future<T> __post_pending_of_arglist_1_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<T>()> task_fn, ks_pending_trigger* trigger) {
		return ks_future<ks_future<T>>::post_pending(apartment, context, std::move(task_fn), trigger)
			.template flat_then<T>(apartment, context, [](const ks_future<T>& value_future) -> ks_future<T> { return value_future; });
	}
	_NO_INLINE static ks_future<T> __post_pending_of_arglist_2_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<T(ks_cancel_inspector*)> task_fn, ks_pending_trigger* trigger) {
		auto raw_task_fn = [task_fn = std::move(task_fn)](const ks_raw_result&)->ks_raw_result {
			T typed_value = task_fn(ks_cancel_inspector::__for_future());
			return ks_raw_value::of<T>(std::move(typed_value));
		};
	...
	_NO_INLINE static ks_future<T> __post_pending_of_arglist_2_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<T>(ks_cancel_inspector*)> task_fn, ks_pending_trigger* trigger) {
		auto raw_task_fn = [task_fn = std::move(task_fn)](const ks_raw_result&)->ks_raw_result {
			ks_result<T> result = task_fn(ks_cancel_inspector::__for_future());
			return result.__get_raw();
		};
	...
	_NO_INLINE static ks_future<T> __post_pending_of_arglist_2_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<T>(ks_cancel_inspector*)> task_fn, ks_pending_trigger* trigger) {
		return ks_future<ks_future<T>>::post_pending(apartment, context, std::move(task_fn), trigger)
			.template flat_then<T>(apartment, context, [](const ks_future<T>& value_future) -> ks_future<T> { return value_future; });
	}
...
private: //__then
	template <class R>
	_NO_INLINE ks_future<R> __then_of_arglist_1_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<R(const T&)> fn) const {
	...
	template <class R>
	_NO_INLINE ks_future<R> __then_of_arglist_1_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<R>(const T&)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_value& raw_value)->ks_raw_result {
	...
	template <class R>
	_NO_INLINE ks_future<R> __then_of_arglist_1_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<R>(const T&)> fn) const {
	...
	template <class R>
	_NO_INLINE ks_future<R> __then_of_arglist_2_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<R(const T&, ks_cancel_inspector*)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_value& raw_value)->ks_raw_result {
	...
	template <class R>
	_NO_INLINE ks_future<R> __then_of_arglist_2_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<R>(const T&, ks_cancel_inspector*)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_value& raw_value)->ks_raw_result {
	...
	template <class R>
	_NO_INLINE ks_future<R> __then_of_arglist_2_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<R>(const T&, ks_cancel_inspector*)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_value& raw_value)->ks_raw_future_ptr {
	...
	template <class R>
	_NO_INLINE ks_future<R> __then_of_arglist_1_ret_x(ks_apartment* apartment, const ks_async_context& context, std::function<void(const T&)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_value& raw_value)->ks_raw_result {
			fn(raw_value.get<T>());
	...
	template <class R>
	_NO_INLINE ks_future<R> __then_of_arglist_2_ret_x(ks_apartment* apartment, const ks_async_context& context, std::function<void(const T&, ks_cancel_inspector*)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_value& raw_value)->ks_raw_result {
...
private: //__transform
	template <class R>
	_NO_INLINE ks_future<R> __transform_of_arglist_1_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<R(const ks_result<T>&)> fn) const {
	...
	template <class R>
	_NO_INLINE ks_future<R> __transform_of_arglist_1_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<R>(const ks_result<T>&)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_result& raw_result)->ks_raw_result {
	...
	template <class R>
	_NO_INLINE ks_future<R> __transform_of_arglist_1_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<R>(const ks_result<T>&)> fn) const {
	...
	template <class R>
	_NO_INLINE ks_future<R> __transform_of_arglist_2_ret_1(ks_apartment* apartment, const ks_async_context& context, std::function<R(const ks_result<T>&, ks_cancel_inspector*)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_result& raw_result)->ks_raw_result {
	...
	template <class R>
	_NO_INLINE ks_future<R> __transform_of_arglist_2_ret_2(ks_apartment* apartment, const ks_async_context& context, std::function<ks_result<R>(const ks_result<T>&, ks_cancel_inspector*)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_result& raw_result)->ks_raw_result {
	...
	template <class R>
	_NO_INLINE ks_future<R> __transform_of_arglist_2_ret_3(ks_apartment* apartment, const ks_async_context& context, std::function<ks_future<R>(const ks_result<T>&, ks_cancel_inspector*)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_result& raw_result)->ks_raw_future_ptr {
	...
	template <class R>
	_NO_INLINE ks_future<R> __transform_of_arglist_1_ret_x(ks_apartment* apartment, const ks_async_context& context, std::function<void(const ks_result<T>&)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_result& raw_result)->ks_raw_result {
	...
	template <class R>
	_NO_INLINE ks_future<R> __transform_of_arglist_2_ret_x(ks_apartment* apartment, const ks_async_context& context, std::function<void(const ks_result<T>&, ks_cancel_inspector*)> fn) const {
		auto raw_fn = [fn = std::move(fn)](const ks_raw_result& raw_result)->ks_raw_result {
...
private: //__on_success, __on_failure, __on_completion
	_NO_INLINE ks_future<T> __on_success_impl(ks_apartment* apartment, const ks_async_context& context, std::function<void(const T&)> fn) const {
	...
	_NO_INLINE ks_future<T> __on_failure_impl(ks_apartment* apartment, const ks_async_context& context, std::function<void(const ks_error&)> fn) const {
	...
	_NO_INLINE ks_future<T> __on_completion_impl(ks_apartment* apartment, const ks_async_context& context, std::function<void(const ks_result<T>&)> fn) const {
...
private:
	...
	template <class R>
	_NO_INLINE ks_future<R> __do_cast(std::integral_constant<__raw_cast_mode_t, __raw_cast_mode_t::to_same> __cast_mode) const {
		return ks_future<R>::__from_raw(m_raw_future);
	}

	template <class R>
	_NO_INLINE ks_future<R> __do_cast(std::integral_constant<__raw_cast_mode_t, __raw_cast_mode_t::to_nothing> __cast_mode) const {
		ks_raw_future_ptr raw_future2 = m_raw_future->then(
	...
	template <class R>
	_NO_INLINE ks_future<R> __do_cast(std::integral_constant<__raw_cast_mode_t, __raw_cast_mode_t::to_other> __cast_mode) const {
		ks_raw_future_ptr raw_future2 = m_raw_future->then(
