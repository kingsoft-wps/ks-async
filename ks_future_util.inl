...
_NO_INLINE ks_future<std::tuple<Ts...>> ks_future_util::__all_for_tuple(std::index_sequence<IDXs...>, const std::tuple<ks_future<Ts>...>& futures) {
...
template <class T>
_NO_INLINE ks_future<std::vector<T>> ks_future_util::__all_for_vector(const std::vector<ks_future<T>>& futures) {
...
template <class... Ts, size_t... IDXs>
_NO_INLINE ks_future<void> ks_future_util::__all_for_tuple_x(std::index_sequence<IDXs...>, const std::tuple<ks_future<Ts>...>& futures) {
...
template <class _>
_NO_INLINE ks_future<void> ks_future_util::__all_for_vector_x(const std::vector<ks_future<void>>& futures) {
	std::vector<ks_raw_future_ptr> raw_arg_futures;
	raw_arg_futures.reserve(futures.size());
	for (auto& future : futures)
		raw_arg_futures.push_back(future.__get_raw());
...
template <class... Ts, size_t... IDXs>
_NO_INLINE ks_future<std::variadic_element_t<0, Ts...>> ks_future_util::__any_for_tuple(std::index_sequence<IDXs...>, const std::tuple<ks_future<Ts>...>& futures) {
...
template <class T>
_NO_INLINE ks_future<T> ks_future_util::__any_for_vector(const std::vector<ks_future<T>>& futures) {
	std::vector<ks_raw_future_ptr> raw_arg_futures;
	raw_arg_futures.reserve(futures.size());
	for (auto& future : futures)
		raw_arg_futures.push_back(future.__get_raw());
...
_NO_INLINE ks_future<void> ks_future_util::parallel(
...
_NO_INLINE ks_future<void> ks_future_util::parallel_n(
...
template <class FNS, class _>
_NO_INLINE ks_future<void> ks_future_util::sequential(
	ks_apartment* apartment, const FNS& fns,
	const ks_async_context& context) {
...
template <class FN, class _>
_NO_INLINE ks_future<void> ks_future_util::sequential_n(
	ks_apartment* apartment, FN&& fn, size_t n,
	const ks_async_context& context) {
...
template <class FN, class _>
_NO_INLINE ks_future<void> ks_future_util::repeat(
...
template <class FN, class _>
_NO_INLINE ks_future<void> ks_future_util::repeat_periodic(
	ks_apartment* apartment, FN&& fn, 
...
_NO_INLINE ks_future<void> ks_future_util::repeat_productive(
...
template <class _>
_NO_INLINE void ks_future_util::__schedule_periodic_once(const std::shared_ptr<__periodic_data_t>& data, int64_t next_delay) {
	ks_future_util
		::post_delayed<void>(
			data->apartment,
			data->fn,
...
template <class V>
_NO_INLINE void ks_future_util::__pump_repetitive_once(const std::shared_ptr< __repetitive_data_t<V>>& data) {
	ks_future_util
		::post<V>(
...
inline std::function<ks_future<T>()> ks_future_util::__wrap_async_fn_0(FN&& fn) {
...
template <class T, class FN> 
inline std::function<ks_future<T>()> ks_future_util::__wrap_async_fn_0_by_arglist(FN&& fn, std::integral_constant<int, 1>) {
...
template <class T, class FN> 
inline std::function<ks_future<T>()> ks_future_util::__wrap_async_fn_0_by_arglist(FN&& fn, std::integral_constant<int, 2>) {
	constexpr int ret_mode =
...
template <class T> 
_NO_INLINE std::function<ks_future<void>()> ks_future_util::__wrap_async_fn_0_by_arglist_ret(std::function<void()> fn, std::integral_constant<int, 1>, std::integral_constant<int, -1>) {
	static_assert(std::is_void_v<T>, "T must be void");
	return [fn = std::move(fn)]() -> ks_future<void> {
		fn();
		return ks_future<void>::resolved(nothing);
	};
}
template <class T> 
_NO_INLINE std::function<ks_future<T>()> ks_future_util::__wrap_async_fn_0_by_arglist_ret(std::function<T()> fn, std::integral_constant<int, 1>, std::integral_constant<int, 1>) {
	return [fn = std::move(fn)]()->ks_future<T> {
		T value = fn();
		return ks_future<T>::resolved(std::move(value));
	};
}
template <class T> 
_NO_INLINE std::function<ks_future<T>()> ks_future_util::__wrap_async_fn_0_by_arglist_ret(std::function<ks_result<T>()> fn, std::integral_constant<int, 1>, std::integral_constant<int, 2>) {
	return [fn = std::move(fn)]()->ks_future<T> {
...
template <class T> 
_NO_INLINE std::function<ks_future<T>()> ks_future_util::__wrap_async_fn_0_by_arglist_ret(std::function<ks_future<T>()> fn, std::integral_constant<int, 1>, std::integral_constant<int, 3>) {
	return[fn = std::move(fn)]()->ks_future<T> {
...
template <class T> 
_NO_INLINE std::function<ks_future<void>()> ks_future_util::__wrap_async_fn_0_by_arglist_ret(std::function<void(ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, -1>) {
	static_assert(std::is_void_v<T>, "T must be void");
	return[fn = std::move(fn)]()->ks_future<void> {
...
template <class T> 
_NO_INLINE std::function<ks_future<T>()> ks_future_util::__wrap_async_fn_0_by_arglist_ret(std::function<T(ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 1>) {
	return[fn = std::move(fn)]()->ks_future<T> {
...
template <class T> 
_NO_INLINE std::function<ks_future<T>()> ks_future_util::__wrap_async_fn_0_by_arglist_ret(std::function<ks_result<T>(ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 2>) {
	return[fn = std::move(fn)]()->ks_future<T> {
...
template <class T> 
_NO_INLINE std::function<ks_future<T>()> ks_future_util::__wrap_async_fn_0_by_arglist_ret(std::function<ks_future<T>(ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 3>) {
	return[fn = std::move(fn)]()->ks_future<T> {
...
inline std::function<ks_future<T>(const ARG1&)> ks_future_util::__wrap_async_fn_1(FN&& fn) {
	constexpr int arglist_mode =
...
template <class T, class ARG1, class FN> 
inline std::function<ks_future<T>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist(FN&& fn, std::integral_constant<int, 1>) {
	constexpr int ret_mode =
...
template <class T, class ARG1, class FN> 
inline std::function<ks_future<T>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist(FN&& fn, std::integral_constant<int, 2>) {
	constexpr int ret_mode =
...
_NO_INLINE std::function<ks_future<void>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist_ret(std::function<void(const ARG1&)> fn, std::integral_constant<int, 1>, std::integral_constant<int, -1>) {
	static_assert(std::is_void_v<T>, "T must be void");
	return [fn = std::move(fn)](const ARG1& arg1)->ks_future<void> {
		fn(arg1);
		return ks_future<void>::resolved(nothing);
	};
}
template <class T, class ARG1> 
_NO_INLINE std::function<ks_future<T>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist_ret(std::function<T(const ARG1&)> fn, std::integral_constant<int, 1>, std::integral_constant<int, 1>) {
	return [fn = std::move(fn)](const ARG1& arg1)->ks_future<T> {
		T value = fn(arg1);
		return ks_future<T>::resolved(std::move(value));
	};
}
template <class T, class ARG1> 
_NO_INLINE std::function<ks_future<T>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist_ret(std::function<ks_result<T>(const ARG1&)> fn, std::integral_constant<int, 1>, std::integral_constant<int, 2>) {
	return [fn = std::move(fn)](const ARG1& arg1)->ks_future<T> {
...
template <class T, class ARG1> 
_NO_INLINE std::function<ks_future<T>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist_ret(std::function<ks_future<T>(const ARG1&)> fn, std::integral_constant<int, 1>, std::integral_constant<int, 3>) {
	return[fn = std::move(fn)](const ARG1& arg1)->ks_future<T> {
...
template <class T, class ARG1> 
_NO_INLINE std::function<ks_future<void>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist_ret(std::function<void(const ARG1&, ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, -1>) {
	static_assert(std::is_void_v<T>, "T must be void");
	return[fn = std::move(fn)](const ARG1& arg1)->ks_future<void> {
...
template <class T, class ARG1> 
_NO_INLINE std::function<ks_future<T>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist_ret(std::function<T(const ARG1&, ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 1>) {
	return[fn = std::move(fn)](const ARG1& arg1)->ks_future<T> {
...
template <class T, class ARG1> 
_NO_INLINE std::function<ks_future<T>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist_ret(std::function<ks_result<T>(const ARG1&, ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 2>) {
	return[fn = std::move(fn)](const ARG1& arg1)->ks_future<T> {
...
template <class T, class ARG1> 
_NO_INLINE std::function<ks_future<T>(const ARG1&)> ks_future_util::__wrap_async_fn_1_by_arglist_ret(std::function<ks_future<T>(const ARG1&, ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 3>) {
	return[fn = std::move(fn)](const ARG1& arg1)->ks_future<T> {
