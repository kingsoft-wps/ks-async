...
private: //__wrap_task_fn
	...
	_NO_INLINE static std::function<ks_result<nothing_t>()> __wrap_task_fn_by_arglist_ret(std::function<void()> task_fn, std::integral_constant<int, 1>, std::integral_constant<int, -1>) {
		return[task_fn = std::move(task_fn)]()->ks_result<nothing_t> {
			task_fn();
			return ks_result<nothing_t>(nothing);
		};
	}
	_NO_INLINE static std::function<ks_result<nothing_t>()> __wrap_task_fn_by_arglist_ret(std::function<ks_result<void>()> task_fn, std::integral_constant<int, 1>, std::integral_constant<int, 2>) {
		return[task_fn = std::move(task_fn)]()->ks_result<nothing_t> {
			return task_fn().template cast<nothing_t>();
		};
	}
	_NO_INLINE static std::function<ks_future<nothing_t>()> __wrap_task_fn_by_arglist_ret(std::function<ks_future<void>()> task_fn, std::integral_constant<int, 1>, std::integral_constant<int, 3>) {
		return[task_fn = std::move(task_fn)]()->ks_future<nothing_t> {
			return task_fn().template cast<nothing_t>();
		};
	}
	_NO_INLINE static std::function<ks_result<nothing_t>()> __wrap_task_fn_by_arglist_ret(std::function<void(ks_cancel_inspector*)> task_fn, std::integral_constant<int, 2>, std::integral_constant<int, -1>) {
		return[task_fn = std::move(task_fn)]()->ks_result<nothing_t> {
			task_fn(ks_cancel_inspector::__for_future());
			return ks_result<nothing_t>(nothing);
		};
	}
	_NO_INLINE static std::function<ks_result<nothing_t>()> __wrap_task_fn_by_arglist_ret(std::function<ks_result<void>(ks_cancel_inspector*)> task_fn, std::integral_constant<int, 2>, std::integral_constant<int, 2>) {
		return[task_fn = std::move(task_fn)]()->ks_result<nothing_t> {
			return task_fn(ks_cancel_inspector::__for_future()).template cast<nothing_t>();
		};
	}
	_NO_INLINE static std::function<ks_future<nothing_t>()> __wrap_task_fn_by_arglist_ret(std::function<ks_future<void>(ks_cancel_inspector*)> task_fn, std::integral_constant<int, 2>, std::integral_constant<int, 3>) {
		return[task_fn = std::move(task_fn)]()->ks_future<nothing_t> {
			return task_fn(ks_cancel_inspector::__for_future()).template cast<nothing_t>();
		};
	}
...
private: //__wrap_then_fn
	...
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const nothing_t&)> __wrap_then_fn_by_arglist_ret(std::function<void()> fn, std::integral_constant<int, 1>, std::integral_constant<int, -1>) {
	...
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const nothing_t&)> __wrap_then_fn_by_arglist_ret(std::function<R()> fn, std::integral_constant<int, 1>, std::integral_constant<int, 1>) {
		return[fn = std::move(fn)](const nothing_t&)->ks_result<R> {
			return ks_result<R>(fn());
		};
	}
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const nothing_t&)> __wrap_then_fn_by_arglist_ret(std::function<ks_result<R>()> fn, std::integral_constant<int, 1>, std::integral_constant<int, 2>) {
		return[fn = std::move(fn)](const nothing_t&)->ks_result<R> {
			return fn();
		};
	}
	template <class R>
	_NO_INLINE static std::function<ks_future<R>(const nothing_t&)> __wrap_then_fn_by_arglist_ret(std::function<ks_future<R>()> fn, std::integral_constant<int, 1>, std::integral_constant<int, 3>) {
	...
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const nothing_t&)> __wrap_then_fn_by_arglist_ret(std::function<void(ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, -1>) {
		static_assert(std::is_void_v<R>, "R must be void");
		return[fn = std::move(fn)](const nothing_t&)->ks_result<void> {
	...
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const nothing_t&)> __wrap_then_fn_by_arglist_ret(std::function<R(ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 1>) {
		return[fn = std::move(fn)](const nothing_t&)->ks_result<R> {
			return ks_result<R>(fn(ks_cancel_inspector::__for_future()));
		};
	}
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const nothing_t&)> __wrap_then_fn_by_arglist_ret(std::function<ks_result<R>(ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 2>) {
		return[fn = std::move(fn)](const nothing_t&)->ks_result<R> {
			return fn(ks_cancel_inspector::__for_future());
		};
	}
	template <class R>
	_NO_INLINE static std::function<ks_future<R>(const nothing_t&)> __wrap_then_fn_by_arglist_ret(std::function<ks_future<R>(ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 3>) {
		return[fn = std::move(fn)](const nothing_t&)->ks_future<R> {
			return fn(ks_cancel_inspector::__for_future());
		};
	}
...
private: //__wrap_transform_fn
	...
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const ks_result<nothing_t>&)> __wrap_transform_fn_by_arglist_ret(std::function<void(const ks_result<void>&)> fn, std::integral_constant<int, 1>, std::integral_constant<int, -1>) {
		static_assert(std::is_void_v<R>, "R must be void");
	...
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const ks_result<nothing_t>&)> __wrap_transform_fn_by_arglist_ret(std::function<R(const ks_result<void>&)> fn, std::integral_constant<int, 1>, std::integral_constant<int, 1>) {
		return[fn = std::move(fn)](const ks_result<nothing_t>& arg)->ks_result<R> {
			return ks_result<R>(fn(arg.cast<void>()));
		};
	}
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const ks_result<nothing_t>&)> __wrap_transform_fn_by_arglist_ret(std::function<ks_result<R>(const ks_result<void>&)> fn, std::integral_constant<int, 1>, std::integral_constant<int, 2>) {
		return[fn = std::move(fn)](const ks_result<nothing_t>& arg)->ks_result<R> {
			return fn(arg.cast<void>());
		};
	}
	template <class R>
	_NO_INLINE static std::function<ks_future<R>(const ks_result<nothing_t>&)> __wrap_transform_fn_by_arglist_ret(std::function<ks_future<R>(const ks_result<void>&)> fn, std::integral_constant<int, 1>, std::integral_constant<int, 3>) {
	...
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const ks_result<nothing_t>&)> __wrap_transform_fn_by_arglist_ret(std::function<void(const ks_result<void>&, ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, -1>) {
		static_assert(std::is_void_v<R>, "R must be void");
		return[fn = std::move(fn)](const ks_result<nothing_t>& arg)->ks_result<void> {
	...
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const ks_result<nothing_t>&)> __wrap_transform_fn_by_arglist_ret(std::function<R(const ks_result<void>&, ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 1>) {
		return[fn = std::move(fn)](const ks_result<nothing_t>& arg)->ks_result<R> {
			return ks_result<R>(fn(arg.cast<void>(), ks_cancel_inspector::__for_future()));
		};
	}
	template <class R>
	_NO_INLINE static std::function<ks_result<R>(const ks_result<nothing_t>&)> __wrap_transform_fn_by_arglist_ret(std::function<ks_result<R>(const ks_result<void>&, ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 2>) {
		return[fn = std::move(fn)](const ks_result<nothing_t>& arg)->ks_result<R> {
			return fn(arg.cast<void>(), ks_cancel_inspector::__for_future());
		};
	}
	template <class R>
	_NO_INLINE static std::function<ks_future<R>(const ks_result<nothing_t>&)> __wrap_transform_fn_by_arglist_ret(std::function<ks_future<R>(const ks_result<void>&, ks_cancel_inspector*)> fn, std::integral_constant<int, 2>, std::integral_constant<int, 3>) {
		return[fn = std::move(fn)](const ks_result<nothing_t>& arg)->ks_future<R> {
			return fn(arg.cast<void>(), ks_cancel_inspector::__for_future());
		};
	}
...
private: //__on_success, __on_failure, __on_completion
	_NO_INLINE ks_future<void> __on_success_impl(ks_apartment* apartment, const ks_async_context& context, std::function<void()> fn) const {
	...
	_NO_INLINE ks_future<void> __on_failure_impl(ks_apartment* apartment, const ks_async_context& context, std::function<void(const ks_error&)> fn) const {
	...
	_NO_INLINE ks_future<void> __on_completion_impl(ks_apartment* apartment, const ks_async_context& context, std::function<void(const ks_result<void>&)> fn) const {
...
public: //map, map_value, cast
	template <class R>
	_NO_INLINE ks_future<R> map(std::function<R()> fn) const {
