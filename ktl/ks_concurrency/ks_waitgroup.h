...
private:
#if defined(_WIN32)
    using _LatchImpl = _KSConcurrencyImpl::ks_waitgroup_win;
#elif defined(__APPLE__)
    using _LatchImpl = _KSConcurrencyImpl::ks_waitgroup_mac;
#elif defined(__linux__)
    using _LatchImpl = _KSConcurrencyImpl::ks_waitgroup_linux;
#else
    using _LatchImpl = _KSConcurrencyImpl::ks_waitgroup_std;
#endif
