...
TEST(test_post_suite, test_post) {
    ...
    future_T.on_completion(ks_apartment::default_mta(), make_async_context(), [&work_wg](const auto& result) {
    ...
    future_result.on_completion(ks_apartment::default_mta(), make_async_context(), [&work_wg](const auto& result) {
        EXPECT_EQ(_result_to_str(result), "pass");
        work_wg.done();
     });
    ...
    future_fu.on_completion(ks_apartment::default_mta(), make_async_context(), [&work_wg](const auto& result) {
        EXPECT_EQ(_result_to_str(result), "pass");
        work_wg.done();
     });
    ...
    future_T_insp.on_completion(ks_apartment::default_mta(), make_async_context(), [&work_wg](const auto& result) {
        if(result.is_error())
    ...
    future_fu_insp.on_completion(ks_apartment::default_mta(), make_async_context(), [&work_wg](const auto& result) {
        if(result.is_error())
            EXPECT_EQ(result.to_error().get_code(), 0xFF338003);
        else
            EXPECT_EQ(_result_to_str(result), "VOID");
...
TEST(test_post_suite, test_post_pending) {
    ...
    future_cancel.on_completion(ks_apartment::default_mta(), make_async_context(), [&work_wg](const auto& result) {
        if(result.is_error())
            EXPECT_EQ(result.to_error().get_code(), 0xFF338003);
        else
            EXPECT_EQ(_result_to_str(result), "VOID");
